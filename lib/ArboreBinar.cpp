...
ArboreBinar::Nod
ArboreBinar::CreareNod(const string &p_informatie_nod, const string &p_informatie_copil, const bool &p_directie)
{
    return new Celula{
            ._informatie = p_informatie_nod,
...
ArboreBinar::Nod ArboreBinar::CreareNod(const string &p_informatie_nod, const string &p_informatie_copil_stang,
                                        const string &p_informatie_copil_drept)
{
    return new Celula{
            ._informatie = p_informatie_nod,
